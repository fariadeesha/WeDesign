...
document.getElementById("hamburguer-icon").onclick = function() {
  ...
  document.getElementById("sliding-header-menu-outer").style.right = "0";// css style use string
...
var aboutUsTabs = document.getElementsByClassName("single-tab");// it will give an array
...
var ourServices = [
  ...
  {
    'title': 'Test Services',
    'text': 'La la la ru ru ru Nunc et quam in magna vehicula sollicitudin. Aliquam erat volutpat. Maecenas dolor mi, aliquet ac quam aliquet, condimentum dictum nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent finibus.'
  }
